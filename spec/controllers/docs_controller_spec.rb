  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved doc as @doc" do
        ...
        allow_any_instance_of(Doc).to receive(:save).and_return(false)
        post :create, {:doc => { "record" => "invalid value" }}, valid_session
        expect(assigns(:doc)).to be_a_new(Doc)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested doc" do
        ...
        expect_any_instance_of(Doc).to receive(:update).with({ "record" => "" })
        put :update, {:id => doc.to_param, :doc => { "record" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the doc as @doc" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Doc).to receive(:save).and_return(false)
        put :update, {:id => doc.to_param, :doc => { "record" => "invalid value" }}, valid_session
        expect(assigns(:doc)).to eq(doc)
      end
